<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RP_History.aspx.cs" Inherits="RP_History" %>
        ...
        <div class="container">
            <div class="row text-left mb-3">
                <div class="col-12 d-inline-flex">
                    ...
                    &nbsp;<p class="membership_title fw-500">RP History</p>
                </div>
            </div>
            ...
            <div class="row mb-5">
                <div class="col-12 table-container">
                    <table class="table">
                        ...
                        <tbody>
                            <asp:Repeater runat="server" ID="rpt_rp_history" OnItemDataBound="rpt_rp_history_ItemDataBound">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td style="width: 15%; vertical-align: middle;">
                                            <asp:Label runat="server" ID="lbl_description"></asp:Label></td>
                                        <td style="width: 15%; vertical-align: middle;">
                                            <asp:Label runat="server" ID="lbl_rp_total"></asp:Label></td>
                                        <td style="width: 15%; vertical-align: middle;">
                                            <asp:Label runat="server" ID="lbl_rp_used"></asp:Label></td>
                                        <td style="width: 15%; vertical-align: middle;">
                                            <asp:Label runat="server" ID="lbl_rp_earn"></asp:Label></td>
                                        <td style="width: 15%; vertical-align: middle;">
                                            <asp:Label runat="server" ID="lbl_rp_balance"></asp:Label></td>
                                        <td style="width: 15%; vertical-align: middle;">
