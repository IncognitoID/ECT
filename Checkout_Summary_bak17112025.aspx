<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Checkout_Summary.aspx.cs" Inherits="Checkout_Summary" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <main>
                    ...
                    <div class="account-box card">
                        ...
                        <div class="row text-left mb-3">
                            <div class="col-12 d-inline-flex">
                                <p class="membership_title fw-200" id="lbl_508"></p>
                            </div>
                        </div>
                        ...
                        <div class="form-section d-flex align-items-center justify-content-between flex-wrap mb-4" style="background: linear-gradient(to right, #f9fafb, #e3f2fd); border-left: 6px solid #2196f3;">
                            <div>
                                ...
                                <div class="d-flex"><p class="mb-0 text-muted small" id="lbl_502">You have </p>&nbsp;<span id="countdownTimer" class="fw-bold text-danger">15:00</span>&nbsp;<p class="mb-0 text-muted small" id="lbl_503"> minutes to complete your order.</p></div>
                            </div>
                            <div>
        ...
        <asp:HiddenField ID="hdn_paymenttype" runat="server" />
    ...
    <script type="text/javascript" class="payment-method-script-3">
        ...
        function handlePaymentChange(dropdown) {
            ...
            var hdn_paymenttype = document.getElementById('<%= hdn_paymenttype.ClientID %>');
            ...
            if (selectedValue === "online") {
                ...
                document.getElementById('div_manual_payment_details').style.display = "none";
                document.getElementById('div_payment_slip').style.display = "none";
                hdn_paymenttype.value = selectedValue;
                $('#ewalletModal').modal('show');
            }
            else if (selectedValue === "pwallet") {
                document.getElementById('div_manual_payment_details').style.display = "none";
                document.getElementById('div_payment_slip').style.display = "none";
                ...
                // Multilingual
                if (language === "Chinese") {
                    document.getElementById('lbl_484').innerText = "使用产品钱包支付";
                    document.getElementById('lbl_486').innerText = "产品钱包余额";
                    document.getElementById('lbl_492').innerText = "产品钱包支付金额";
                    document.getElementById('lbl_494').innerText = "最终产品钱包余额";
                    document.getElementById('lbl_499').innerText = "产品钱包支付";
                }
                else {
                    document.getElementById('lbl_484').innerText = "Pay with Product Wallet";
                    document.getElementById('lbl_486').innerText = "Product Wallet Balance";
                    document.getElementById('lbl_492').innerText = "Product Wallet Pay Amount";
                    document.getElementById('lbl_494').innerText = "Final Product Wallet Balance";
                    document.getElementById('lbl_499').innerText = "Product Wallet Payment";
                }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (data.IsValid) {
                        ...
                        var hdn_paymenttype = document.getElementById('<%= hdn_paymenttype.ClientID %>')
                        console.log(hdn_paymenttype.value);
                        if (hdn_paymenttype.value == "ewallet") {
                            ...
                            // Format and set wallet balance
                            var walletBalance = parseFloat(data.PWalletBalance || 0);
                            var walletFormatted = "RM " + walletBalance.toLocaleString('en-MY', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            });
                            hdn_wallet_balance.value = data.PWalletBalance;
                            document.getElementById('<%= lbl_wallet_balance.ClientID %>').innerText = walletFormatted;
        ...
        function updateEwalletCalculation() {
            ...
            console.log(hdn_wallet_balance.value);
            console.log(lbl_wallet_balance.innerText);
    ...
    <script>
        ...
        <%--$(document).ready(function () {
            const fileInputId = '<%= file_payment_slip.ClientID %>';
        ...
        <%--if (validFiles === 0) {
            $('#<%= lbl_upload_status.ClientID %>')
                .text("All selected files are invalid. Only JPG, JPEG, PNG allowed.")
                .removeClass("text-success").addClass("text-danger");
        } else {
            $('#<%= lbl_upload_status.ClientID %>')
                        .text(validFiles + " valid file(s) selected.")
