<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Register_Member_Stockist_Checkout.aspx.cs" Inherits="Register_Member_Stockist_Checkout" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <form>
                        ...
                        <div class="row mt-4">
                                        ...
                                        <div class="form-group mb-3" id="div_downline" style="display: none;">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="w-100 mt-5" style="border: 1px solid #e8e8e8; border-radius: 5px; padding: 10px 10px; margin-top: 5px; display: none;"
                            ...
                            <div class="col-lg-5" id="col_package" runat="server">
                                <div class="form-group mb-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <label for="ctl00_ContentPlaceHolder1_btn_shopper" class="toggle" id="btn_shopper_button">
                                ...
                                <div class="form-group mb-3" id="div_profit_center">
                                    <div class="row align-items-center">
                                        <div class="col-lg-4">
                                            <label class="mb-1" id="lbl_115">Profit Center*</label>
                                        </div>
                                        <div class="col-lg-8">
                                            <select runat="server" id="ddl_package" class="form-control dropdownlist" onclick="updateTitle()">
                                                <option value="" id="lbl_116" disabled>Select your package</option>
                                                <option value="1" id="lbl_117">Business Owner (1,000BV)</option>
            ...
            <div class="col-12 m-auto">
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 m-auto paymentsliptextdiv">
                        <div class="col-12">
                            <div class="col-12">
                                <label id="lbl_payment_slip" class="mb-3 font-weight-bold paymentslipstyle">Please Upload Payment Slip</label>
                            </div>
                            <div class="col-12 paymentrequirement1">
                                <span style="color: red;">*Minimum 1 Payment Slip</span>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-10 notecontent">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                <asp:DropDownList runat="server" ID="ddl_payment_type" CssClass="form-control w-100 new_address_textbox" onchange="togglePaymentType()">
                                    <asp:ListItem Value="Cash" Text="Cash"></asp:ListItem>
                                    <asp:ListItem Value="Bank Transfer" Text="Bank Transfer" Selected="True"></asp:ListItem>
                                    <asp:ListItem Value="DuitNow QR" Text="DuitNow QR"></asp:ListItem>
                                    <asp:ListItem Value="Credit Card / Debit Card" Text="Credit Card / Debit Card"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>

                        <div class="row mb-1" id="div_payment_reference">
                            <div class="col-4 m-auto">
                            ...
                            <div class="col-7">
                                <asp:TextBox runat="server" ID="txt_payment_reference" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                <asp:TextBox runat="server" ID="txt_remark" CssClass="form-control" MaxLength="200"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <asp:Button runat="server" Text="Place Order" CssClass="hidden btn btn_primary bg-black text-white" ID="btn_check_fileupload" OnClick="btn_check_fileupload_Click" OnClientClick="ShowLoading()" formnovalidate />
    ...
    <script type="text/javascript">
        ...
        function togglePaymentType() {
            ...
            var txt_payment_reference = document.getElementById('<%= txt_payment_reference.ClientID %>');
            var div_payment_reference = document.getElementById('div_payment_reference');

            if (ddl_payment_type.value === 'Cash') {
                div_payment_reference.style.display = 'none';
                txt_payment_reference.value = "";
            } else {
                div_payment_reference.style.display = 'flex';
            }
        }
    ...
    <script type="text/javascript">
        ...
        function sweetalert_warning(message, messagetype) {
            ...
            Reassign_Password_Value();
        }

        function Reassign_Password_Value() {
            var id = getParameterByName('id');
            $.ajax({
                type: "POST",
                url: "Register_Member_Stockist_Checkout.aspx/Reassign_password",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ id: id }),
                success: function (response) {
                    var responseData = JSON.parse(response.d); // Parse the response JSON string
                    for (var i = 0; i < responseData.member_details.length; i++) {
                        var member_details = responseData.member_details[i];

                        var txt_password = document.getElementById('<%=txt_password.ClientID%>');
                        var txt_confirmpassword = document.getElementById('<%=txt_confirmpassword.ClientID%>');
                        txt_password.value = member_details.DecryptedPassword;
                        txt_confirmpassword.value = member_details.DecryptedPassword;
                    }
                },
        ...
        function CheckFirstVariation() {
            ...
            $.ajax({
                type: "POST",
                url: "Register_Member_Stockist_Checkout.aspx/ProcessArray",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
