<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Upgrade_To_BO_Product_List.aspx.cs" Inherits="Upgrade_To_BO_Product_List" %>
    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function Load_Language() {
                var page = 'Upgrade BO Product Listing';
            ...
            function redirectToProduct(productCode) {
                ...
                window.location.href = "Upgrade_To_BO_Product_Details.aspx?id=" + productCode;
            }
            ...
            function CheckFirstVariation() {
                ...
                $.ajax({
                    type: "POST",
                    url: "Upgrade_To_BO_Product_List.aspx/ProcessArray",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
