<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Register_Member.aspx.cs" Inherits="Register_Member" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                            ...
                            <div class="col-lg-5">
                                    ...
                                    <ContentTemplate>
                                        <div class="form-group mb-3">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-8">
                                                    <asp:DropDownList runat="server" ID="ddl_country" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddl_country_SelectedIndexChanged" onchange="toggleCountry()">
                                                    </asp:DropDownList>
                                ...
                                <div class="form-group mb-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" runat="server" id="txt_postcode" type="text" maxlength="10" autocomplete="off" onkeypress='return (event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 45 || event.charCode == 32' />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row mt-5">
                            <div class="col-lg-5">
                                ...
                                <asp:UpdatePanel runat="server">
                                    <ContentTemplate>
                                        <div class="form-group mb-3" id="div_downline" runat="server" style="display:none">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4">
                                                </div>
                                                <div class="col-lg-8">
                                                    <asp:DropDownList CssClass="form-control" runat="server" ID="ddl_member_placement" AutoPostBack="true" onchange="toggleDiv()">
                                                    ...
                                                    <div class="w-100 mt-4" style="border: 1px solid #e8e8e8; border-radius: 5px; padding: 10px 10px; margin-top: 5px; display: none;" runat="server" id="div_id">
                                                    ...
                                                    <div class="w-100" style="border: 1px solid #e8e8e8; border-radius: 5px; padding: 10px 10px; margin-top: 5px; flex-direction: column; display: none;" runat="server" id="div_placement">
                                                        ...
                                                        <asp:DropDownList CssClass="form-control w-100" runat="server"  AutoPostBack="true" ID="ddl_default_placement">
    ...
    <script type="text/javascript">
        ...
        function Member_Type(type) {
            ...
            var div_downline = document.getElementById('<%= div_downline.ClientID %>');
        ...
        function countryChanged(ddl) {
            let country = ddl.value;
            if (country !== "") {
                LoadStateDropdown(country);
            }
        }


        function LoadStateDropdown(countryCode) {
            $.ajax({
                type: "POST",
                url: "Register_Member.aspx/GetStateData",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ countryCode: countryCode }),
                success: function (response) {
                    // response.d is already a JavaScript array, no need to parse
                    var stateData = response.d;
                    var $ddlState = $("#ContentPlaceHolder1_ddl_State");

                    // Clear and add default option
                    $ddlState.empty();
                    var defaultText = getCookie("language") === "Chinese" ? "选择您的州属" : "Select your state";
        ...
        function BinaryPlacementCheckbox() {
            ...
            if (checkbox.checked) {
                ...
                // ALWAYS restore UI after any AJAX update
                sessionStorage.setItem("showBinary", "1");
            }
        }

        // Restore Binary Panel after country AJAX updates
        Sys.WebForms.PageRequestManager.getInstance().add_endRequest(function () {
            if (sessionStorage.getItem("showBinary") == "1") {
                document.getElementById('<%= div_downline.ClientID %>').style.display = "block";
            }
        });
