            ...
            <div class="row mb-5">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="box_style mt-4">
                        <div class="col-12">
                            <span class="available_balace_title">Current Product Wallet Balance</span>
                        </div>
                        <div class="col-12 mt-4 mb-4">
                            <asp:Label runat="server" ID="lbl_product_wallet_amount" CssClass="available_balace_amount"></asp:Label>
                        </div>
                        <div class="col-12">
                            <asp:Button runat="server" Text="Transaction >" ID="btn_view_productwallet_transaction" OnClick="btn_view_productwallet_transaction_Click" CssClass="view_transaction" />
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-6 payout_div">
                    <div class="box_style">
                        ...
                        <div class="col-12 mt-4 mb-4 Payout_balance_title">
                            <span>Payout Maturity in 3 days</span>
                        </div>
                        <div class="col-12 mt-4 mb-4">
