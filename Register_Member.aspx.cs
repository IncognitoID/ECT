...
[WebMethod]
    public static object GetStateData(string countryCode)
    {
            ...
            using (SqlCommand cmd = new SqlCommand("Load_State", con))
            {
                ...
                if (idr.HasRows)
                {
                    while (idr.Read())
                    {
                        stateList.Add(new
                        {
                            Statename = idr["Statename"].ToString(),
                            Statecode = idr["Statecode"].ToString()
                        });
                    }
                }
                idr.Close();
        ...
        return stateList; // Return the list directly, don't serialize it
    }
