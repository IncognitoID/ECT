...
public partial class Checkout : System.Web.UI.Page
{
    ...
    protected void Calculate_Shipping_Fees(string memberid)
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("Load_Member_Cart", con))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Memberid", memberid);
                con.Open();
            ...
            if (got_item)
            {
                foreach (DataRow dr in cart.Rows)
                {
                    ...
                    {
                        total_weight = total_weight + (Convert.ToDecimal(dr["Product_Weight"].ToString()) * (Convert.ToDecimal(dr["Normal_Quantity"].ToString()) + Convert.ToDecimal(dr["DC_Quantity"].ToString()) + Convert.ToDecimal(dr["RP_Quantity"].ToString())));
                    }
                    else
                    {
                        total_weight = total_weight + (Convert.ToDecimal(dr["Variation_Weight"].ToString()) * (Convert.ToDecimal(dr["Normal_Quantity"].ToString()) + Convert.ToDecimal(dr["DC_Quantity"].ToString()) + Convert.ToDecimal(dr["RP_Quantity"].ToString())));
                    }
                }
                total_weight = Math.Ceiling(total_weight / 1000) * 1000;

                using (SqlCommand cmd = new SqlCommand("Load_Member_Shipping_Fees", con))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
    ...
    protected void rpt_cart_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        Label lbl_total_rp_amount = (Label)e.Item.FindControl("lbl_total_rp_amount");
        ...
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            {
                lbl_total_weight.Text = ((Convert.ToDecimal(drv.Row["Normal_Quantity"].ToString()) + Convert.ToDecimal(drv.Row["DC_Quantity"].ToString()) + Convert.ToDecimal(drv.Row["RP_Quantity"].ToString())) * Convert.ToDecimal(drv.Row["Product_Weight"].ToString())).ToString("###,###,##0.00");
                ...
                {
                    lbl_product_price.Text = "RM " + (Convert.ToDecimal(drv.Row["Product_Retail_Price"].ToString()) * Convert.ToDecimal(drv.Row["Normal_Quantity"].ToString())).ToString("###,###,##0.00");
                ...
                if (drv.Row["RP_Quantity"].ToString() == "0")
                {
                    lbl_rp_qty.Text = "0";
                    lbl_rp_used.Text = "0";
                    lbl_total_rp_amount.Text = "0";
                }
                else
                {
                    lbl_rp_qty.Text = drv.Row["RP_Quantity"].ToString();
                    lbl_rp_used.Text = (Convert.ToDecimal(drv.Row["Product_RP_Points"].ToString()) * Convert.ToDecimal(drv.Row["RP_Quantity"].ToString())).ToString("###,###,##0");
                    lbl_total_rp_amount.Text = (Convert.ToDecimal(drv.Row["Product_RP_Points"].ToString()) * Convert.ToDecimal(drv.Row["RP_Quantity"].ToString())).ToString("###,###,##0"); ;
                }
                ...
                decimal totalBV = normal_bv + promotion_bv;
                lbl_bv_earn.Text = totalBV == 0 ? "0" : totalBV.ToString("###,###,###");
            ...
            {
                lbl_total_weight.Text = ((Convert.ToDecimal(drv.Row["Normal_Quantity"].ToString()) + Convert.ToDecimal(drv.Row["DC_Quantity"].ToString()) + Convert.ToDecimal(drv.Row["RP_Quantity"].ToString())) * Convert.ToDecimal(drv.Row["Variation_Weight"].ToString())).ToString("###,###,##0.00");
                ...
                {
                    lbl_product_price.Text = "RM " + (Convert.ToDecimal(drv.Row["Variation_Retail_Price"].ToString()) * Convert.ToDecimal(drv.Row["Normal_Quantity"].ToString())).ToString("###,###,##0.00");
                    lbl_qty.Text = drv.Row["Normal_Quantity"].ToString();
                ...
                else
                {
                    ...
                    lbl_dc_price.Text = "RM " + (Convert.ToDecimal(drv.Row["Variation_Promotion_Price_Selling_Price"].ToString()) * Convert.ToDecimal(drv.Row["DC_Quantity"].ToString())).ToString("###,###,##0.00");
                    lbl_dc_qty.Text = drv.Row["DC_Quantity"].ToString();
                ...
                {
                    lbl_rp_qty.Text = drv.Row["RP_Quantity"].ToString();
                    lbl_rp_used.Text = (Convert.ToDecimal(drv.Row["Variation_Product_RP_Points"].ToString()) * Convert.ToDecimal(drv.Row["RP_Quantity"].ToString())).ToString("###,###,##0");
                    lbl_total_rp_amount.Text = (Convert.ToDecimal(drv.Row["Variation_Product_RP_Points"].ToString()) * Convert.ToDecimal(drv.Row["RP_Quantity"].ToString())).ToString("###,###,##0"); ;
                }
            ...
            lbl_total_qty.Text = (Convert.ToInt32(lbl_total_qty.Text) + Convert.ToInt32(drv.Row["Normal_Quantity"].ToString()) + Convert.ToInt32(drv.Row["DC_Quantity"].ToString()) + Convert.ToInt32(drv.Row["RP_Quantity"].ToString())).ToString();
            ...
            lbl_total_rp_used.Text = (Convert.ToInt32(lbl_total_rp_used.Text.Replace(",", "")) + Convert.ToInt32(Decimal.Truncate(Convert.ToDecimal(lbl_rp_used.Text.Replace(",", ""))))).ToString("###,###,##0");
            ...
            lbl_sub_total.Text = "RM " + (subTotal + totalAmount).ToString("###,###,##0.00");

            decimal total = Convert.ToDecimal(lbl_sub_total.Text.Replace("RM ", "").Replace(",", ""));

            lbl_total_amout.Text = "RM " + (total).ToString("###,###,##0.00");
    ...
    protected void rpt_cart_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("Delete_Cart_Item", con))
            {
                cmd.CommandType = CommandType.StoredProcedure;
    ...
    protected void Load_Product_Variation(string Cart_ID, string quantity)
    {
        ...
        using (SqlCommand cmd = new SqlCommand("Load_Front_End_Checkout_Product_Details", con))
        {
            con.Open();
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                if (string.IsNullOrEmpty(dt.Rows[0]["Cart_Variation_Value"].ToString()))
                {
                    ...
                    txtQuantity3.Text = dt.Rows[0]["RP_Quantity"].ToString();
    ...
    protected void AddItemtoCart(string itemcode, string variation)
    {
        using (SqlCommand cmdcheckvariation = new SqlCommand("Check_Cart", con))
        {
            ...
            if (v2.Rows.Count > 0)
            {
                using (SqlCommand cmdinsertcart = new SqlCommand("Update_Cart_Checkout", con))
                {
            ...
            {
                using (SqlCommand cmdinsertcart = new SqlCommand("Insert_Cart_Checkout", con))
                {
                    cmdinsertcart.CommandType = CommandType.StoredProcedure;
                    cmdinsertcart.Parameters.AddWithValue("@MemberID", Request.Cookies["userid"].Value);
                    cmdinsertcart.Parameters.AddWithValue("@ItemCode", itemcode);
    ...
    protected void btn_submit_Click(object sender, EventArgs e)
    {
        ...
        else if (ddl_country.SelectedValue == "")
        {
    ...
    protected void btn_place_order_Click(object sender, EventArgs e)
    {
        ...
        if (cookieExists == true)
        {
            if (Request.Cookies["userid"].Value != null && Request.Cookies["userid"].Value != "")
            {
                ...
                if (GotItem == true && ItemNotAvailable == false && Country_Available == true && RP_Available == true)
                {
    ...
    {
        DataTable v = new DataTable();
        using (SqlCommand cmd = new SqlCommand("Load_Member_Checkout_Cart", con))
        {
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            {
                ShowMessage_warning("There is no item in your cart", MessageType.Warning);
                return;
            }
        ...
        decimal Total_RP_Points_Used = 0;
        decimal Member_Total_RP_Points = 0;

        foreach (DataRow dr in v.Rows)
        {
            Member_Total_RP_Points = Convert.ToDecimal(dr["Member Total RP Points"].ToString());
            using (SqlCommand cmd = new SqlCommand("Check_Product_Qty", con))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                cmd.Parameters.AddWithValue("@RP_Quantity", dr["RP_Quantity"].ToString());
                ...
                if(Status == "SUCCESS")
                {
                    Total_RP_Points_Used = Total_RP_Points_Used +(Convert.ToDecimal(dr["RP Points"].ToString()) * Convert.ToDecimal(dr["RP_Quantity"].ToString()));
                }
        ...
        if (Total_RP_Points_Used > Member_Total_RP_Points)
        {
            RP_Available = false;
            string message = "";
            message = "Insufficient RP in your account";
            ShowMessage_warning(message, MessageType.Warning);
            return;
        }
    }
    ...
    protected void Insert_Order(string member_id)
    {
        ...
        foreach (DataRow row in v.Rows)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("Insert_SOItem_Single_Item", con))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                con.Open();
                ...
                {
                    total_weight = (Convert.ToDecimal(row["Normal_Quantity"].ToString()) + Convert.ToDecimal(row["DC_Quantity"].ToString()) + Convert.ToDecimal(row["RP_Quantity"].ToString())) * Convert.ToDecimal(row["Product_Weight"].ToString());
                    ...
                    if (row["RP_Quantity"].ToString() == "0")
                    {
                        rp_points = 0;
                    }
                    else
                    {
                        rp_points = Convert.ToDecimal(row["Product_RP_Points"].ToString());
                        total_rp_used = (Convert.ToDecimal(row["Product_RP_Points"].ToString()) * Convert.ToDecimal(row["RP_Quantity"].ToString()));
                    }
                    ...
                    cmd.Parameters.AddWithValue("@RP_Points", rp_points);
                    ...
                    cmd.Parameters.AddWithValue("@Total_RP_Used", total_rp_used);
                }
                else
                {
                    total_weight = (Convert.ToDecimal(row["Normal_Quantity"].ToString()) + Convert.ToDecimal(row["DC_Quantity"].ToString()) + Convert.ToDecimal(row["RP_Quantity"].ToString())) * Convert.ToDecimal(row["Variation_Weight"].ToString());
                    ...
                    {
                        rp_points = Convert.ToDecimal(row["Variation_Product_RP_Points"].ToString());
                        total_rp_used = (Convert.ToDecimal(row["Variation_Product_RP_Points"].ToString()) * Convert.ToDecimal(row["RP_Quantity"].ToString()));
                    }
                ...
                cmd.Parameters.AddWithValue("@RP_Qty", row["RP_Quantity"].ToString());
            ...
            total_qty = total_qty + Convert.ToInt32(row["Normal_Quantity"].ToString()) + Convert.ToInt32(row["DC_Quantity"].ToString()) + Convert.ToInt32(row["RP_Quantity"].ToString());
            ...
            final_total_rp_used = final_total_rp_used + Convert.ToInt32(total_rp_used);
        ...
        using (SqlCommand cmd2 = new SqlCommand("Insert_SOHeader_Single_Item", con))
        {
            con.Open();
            ...
            cmd2.Parameters.AddWithValue("@Total_RP_Used", final_total_rp_used);
            ...
            if(string.IsNullOrEmpty(Request.QueryString["addressid"].ToString()))
            {
                cmd2.Parameters.AddWithValue("@Address_ID", "Default");
            }
            else
            {
                cmd2.Parameters.AddWithValue("@Address_ID", Request.QueryString["addressid"].ToString());
            }
            cmd2.Parameters.AddWithValue("@DeliveryMessage", "");
            cmd2.Parameters.AddWithValue("@PaymentType", payment_method);
            cmd2.Parameters.AddWithValue("@PaymentID", "");
            cmd2.Parameters.AddWithValue("@PaymentStatus", payment_status);
            cmd2.Parameters.AddWithValue("@PaymentRef", "");
            cmd2.Parameters.AddWithValue("@PaymentAmt", total_price);
            cmd2.Parameters.AddWithValue("@Wallet_Amount", wallet_amount);
        ...
        cmd_cart.CommandText = "DELETE FROM MF_Member_Cart WHERE IDs IN (SELECT CartID FROM SO_Item WHERE Order_No = '" + orderid + "')";
        ...
        if (total_price > 0)
        {
            Response.Cookies["Payment_order_no"].Value = orderid;
            Response.Redirect("Checkout_Summary.aspx");
        ...
        else if (total_price == 0 && final_total_rp_used > 0)
        {
            Response.Cookies["order_no"].Value = orderid;
