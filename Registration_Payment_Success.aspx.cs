...
public partial class Registration_Payment_Success : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            bool cookieExists2 = HttpContext.Current.Request.Cookies["Registration_Success_order_no"] != null;
            ...
            if (cookieExists == true)
            {
                if (Request.Cookies["userid"].Value != null && Request.Cookies["userid"].Value != "")
                {
                    ...
                    {
                        if (Request.Cookies["Registration_Success_order_no"].Value != null && Request.Cookies["Registration_Success_order_no"].Value != "")
                        {
                            ...
                            using (SqlCommand cmd = new SqlCommand("Upgrade_Level_Load_Order_Details_Temporarily", con))
                            {
                                ...
                                cmd.Parameters.AddWithValue("@OrderNo", Request.Cookies["Registration_Success_order_no"].Value);
                                con.Open();
                            ...
                            {
                                cmd.CommandType = CommandType.StoredProcedure;
                                cmd.Parameters.AddWithValue("@Order_No", Request.Cookies["Registration_Success_order_no"].Value);
                                cmd.Parameters.AddWithValue("@Order_Status", "To Ship");
                                cmd.Parameters.AddWithValue("@Payment_Status", "Paid");
                                cmd.Parameters.AddWithValue("@Payment_Reference", "");
                                con.Open();
                                cmd.ExecuteNonQuery();
                                con.Close();
                            }
                            ...
                            System.Web.HttpCookie myCookie = new System.Web.HttpCookie("Registration_Success_order_no");
