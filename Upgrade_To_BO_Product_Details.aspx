<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Upgrade_To_BO_Product_Details.aspx.cs" Inherits="Upgrade_To_BO_Product_Details" %>
    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function BackToPreviousPage() {
                window.location.href = "Upgrade_To_BO_Product_List.aspx";
            }
            ...
            function CheckFirstVariation() {
                ...
                $.ajax({
                    type: "POST",
                    url: "Upgrade_To_BO_Product_Details.aspx/ProcessArray",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
