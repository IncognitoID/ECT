...
public partial class Register_Member_Open_New_Account_Product_List : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("Register_Member.aspx?id=" + Request.QueryString["id"].ToString());
    }
    ...
    protected void btn_continue_Click(object sender, EventArgs e)
    {
        ...
        if(v.Rows.Count > 0)
        {
            using (SqlCommand cmd = new SqlCommand("Check_Regsitration_Member_Cart", con))
            {
                ...
                {
                    Response.Redirect("Register_Member_Open_New_Account_Checkout.aspx?id=" + Request.QueryString["id"].ToString());
                }
