...
public partial class Register_Member_Product_Details : System.Web.UI.Page
{
    ...
    //        rpt_product_image.DataSource = v;
    //        rpt_product_image.DataBind();
    ...
    protected void Load_Product_Details()
    {
        ...
        using (SqlCommand cmd = new SqlCommand("Load_Front_End_Registration_Product_Details", con))
        {
            ...
            cmd.Parameters.AddWithValue("@Member_ID", Request.QueryString["member_id"].ToString());
    ...
    protected void AddItemtoCart(string itemcode, string variation)
    {
        using (SqlCommand cmdcheckvariation = new SqlCommand("Check_Registration_Cart", con))
        {
            ...
            cmdcheckvariation.Parameters.AddWithValue("@MemberID", Request.QueryString["member_id"].ToString());
            ...
            if (v2.Rows.Count > 0)
            {
                using (SqlCommand cmdinsertcart = new SqlCommand("Update_Registration_Cart", con))
                {
                    ...
                    cmdinsertcart.Parameters.AddWithValue("@MemberID", Request.QueryString["member_id"].ToString());
