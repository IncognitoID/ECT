<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Register_Member_Open_New_Account_Product_Details.aspx.cs" Inherits="Register_Member_Open_New_Account_Product_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container mt-2 mb-2 pl-4 pr-4">
        <div class="row" style="border-bottom: 1px solid #efefef;">
            <div class="col-12 p-0">
                <div onclick="BackToPreviousPage()"><label style="padding: 7px 15px; margin: 10px 0px; background-color: #232020; color: white; border-radius: 5px;">Back</label></div>
            </div>
        </div>
            ...
            <div class="column-xs-12 column-md-6 product_details_margin font_black">
                ...
                <p class="mb-2">
                    <div style="font-size: 14px; border: 1px solid #e4dfdf; padding: 10px; border-radius: 10px; margin-bottom: 1rem;">
                        <span id="lbl_267"></span>&nbsp;<asp:Label runat="server" ID="lbl_total_quantity"></asp:Label>&nbsp;<span id="lbl_272"></span>
                        <br />
    ...
    <script type="text/javascript">
        ...
        function BackToPreviousPage() {
            ...
            window.location.href = "Register_Member_Open_New_Account_Product_List.aspx?id=" + member_id;
        }
        ...
        function CheckFirstVariation() {
            ...
            $.ajax({
                type: "POST",
                url: "Register_Member_Open_New_Account_Product_Details.aspx/ProcessArray",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
