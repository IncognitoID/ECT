<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Register_Member_Product_List.aspx.cs" Inherits="Register_Member_Product_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function redirectToProduct(productCode) {
            ...
            window.location.href = "Register_Member_Product_Details.aspx?id=" + productCode + "&member_id=" + member_id;
        }
        ...
        function VariationSeleted() {
            ...
            setTimeout(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "Register_Member_Product_List.aspx/ProcessArray",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({ myArray: arrayvariation, id: id }),
                    success: function (response) {
