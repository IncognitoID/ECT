...
public partial class Register_Member_Product_List : System.Web.UI.Page
{
    ...
    protected void btn_continue_Click(object sender, EventArgs e)
    {
        ...
        if(v.Rows.Count > 0)
        {
            using (SqlCommand cmd = new SqlCommand("Check_Regsitration_Member_Cart", con))
            {
                ...
                {
                    Response.Redirect("Register_Member_Checkout.aspx?id=" + Request.QueryString["id"].ToString());
                }
