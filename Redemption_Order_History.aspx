<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Redemption_Order_History.aspx.cs" Inherits="Redemption_Order_History" %>
        ...
        <div class="container">
            ...
            <div class="row text-left mb-3">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-inline-flex">
                    ...
                    &nbsp;<p class="membership_title fw-500">Redemption Order History</p>
                </div>
            </div>
