<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Upgrade_To_BO_Checkout.aspx.cs" Inherits="Upgrade_To_BO_Checkout" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Upgrade To BO</title>
    ...
    <script type="text/javascript">
        function Show_Variation() {
            ...
            var rbtnlist_element = document.getElementById("rbtnlist_variation_value");
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                ...
                <section class="container mt-3 pl-4 pr-4">
                    <div class="row">
                        <div class="col-12 m-auto">
                            <div class="row text-left mt-3 mb-3">
                                <div class="col-12 d-inline-flex">
                                    <p class="membership_title fw-200" id="lbl_341">Activate Account - </p>
                                    &nbsp;<p class="membership_title fw-200" id="lbl_342">Summary</p>
                                </div>
                            </div>
        ...
        <script type="text/javascript">
            ...
            function CheckFirstVariation() {
                ...
                $.ajax({
                    type: "POST",
                    url: "Activate_Account_Checkout.aspx/ProcessArray",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
        ...
        <script type="text/javascript">
            ...
            function UpdateCart() {
                ...
                if (divStyle.display === "block") {
                    ...
                    document.getElementById("btn_final_update_cart").click();
                }
            }
