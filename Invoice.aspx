            ...
            <div class="row">
                ...
                <div class="col-md-5 col-5">
                    <table class="invoice_font_size">
                        ...
                        <tr>
                            <td>
                                <label class="title">Wallet Amount</label></td>
                            <td>
                                <label>:&nbsp;</label></td>
                            <td>
                                <asp:Label runat="server" ID="lbl_wallet_amount" CssClass="invoice_label"></asp:Label></td>
                        </tr>
                        <tr style="display:none">
                            <td>
                                <label class="title">Product Wallet Amount</label></td>
                            <td>
                                <label>:&nbsp;</label></td>
                            <td>
                                <asp:Label runat="server" ID="lbl_product_wallet_amount" CssClass="invoice_label"></asp:Label></td>
                        </tr>
                        <tr>
                            <td>
