<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Register_Member_Open_New_Account_Product_List.aspx.cs" Inherits="Register_Member_Open_New_Account_Product_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container p-3 mt-2 mb-5">
        ...
        <div class="row text-left mb-3">
            <div class="col-12 d-inline-flex">
                ...
                &nbsp;<p class="membership_title fw-200" id="lbl_346">Package - </p>
    ...
    <script type="text/javascript">
        ...
        function redirectToProduct(productCode) {
            ...
            window.location.href = "Register_Member_Open_New_Account_Product_Details.aspx?id=" + productCode + "&member_id=" + member_id;
        }
        ...
        function CheckFirstVariation() {
            ...
            $.ajax({
                type: "POST",
                url: "Register_Member_Open_New_Account_Product_List.aspx/ProcessArray",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
