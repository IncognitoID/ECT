<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Register_Member_Stockist_Product_Details.aspx.cs" Inherits="Register_Member_Stockist_Product_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function BackToPreviousPage() {
            ...
            window.location.href = "Register_Member_Stockist_Product_List.aspx?id=" + member_id;
        }
        ...
        function CheckFirstVariation() {
            ...
            $.ajax({
                type: "POST",
                url: "Register_Member_Stockist_Product_Details.aspx/ProcessArray",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
