<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Upgrade_To_EO_Product_Details.aspx.cs" Inherits="Upgrade_To_EO_Product_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function BackToPreviousPage() {
            ...
            window.location.href = "Upgrade_To_EO_Product_List.aspx?id=" + member_id + "&Agent_Level=" + Agent_Level + "&Package=" + Package;
        }
