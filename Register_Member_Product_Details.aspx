<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Register_Member_Product_Details.aspx.cs" Inherits="Register_Member_Product_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function BackToPreviousPage() {
            ...
            window.location.href = "Register_Member_Product_List.aspx?id=" + member_id;
        }
