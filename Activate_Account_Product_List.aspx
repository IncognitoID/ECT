<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Activate_Account_Product_List.aspx.cs" Inherits="Activate_Account_Product_List" %>
    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function redirectToProduct(productCode) {
                ...
                window.location.href = "Activate_Account_Product_Details.aspx?id=" + productCode;
            }
            ...
            function CheckFirstVariation() {
                ...
                $.ajax({
                    type: "POST",
                    url: "Activate_Account_Product_List.aspx/ProcessArray",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
