...
public partial class Register_Member_Share_Link : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (!string.IsNullOrEmpty(Request.QueryString["referral_id"]))
            {
                GetReferal(Request.QueryString["referral_id"].ToString());
            }
    ...
    protected void Register_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("Insert_New_Member_Share_Link_Temporarily", con))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("Type", Type);
                        cmd.Parameters.AddWithValue("Action_By", txt_referal_id.Value.Trim());
                        ...
                        if (StatusExists == "success")
                        {
                            ...
                            Response.Redirect("Register_Member_Share_Link_Product_List.aspx?referral_id=" + Request.QueryString["referral_id"].ToString() + "&id=" + userid);
                        }
    ...
    protected void Update_Member_Details(string member_id)
    {
        ...
        using (SqlCommand cmd = new SqlCommand("Update_Member_Details_Share_Link_Temporarily", con))
        {
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("Type", Type);
