<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Register_Member_Checkout.aspx.cs" Inherits="Register_Member_Checkout" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
                                        ...
                                        <div class="form-group mb-3" id="div_downline" style="display: none;">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="w-100 mt-3" style="border: 1px solid #e8e8e8; border-radius: 5px; padding: 10px 10px; margin-top: 5px; display: none;"
