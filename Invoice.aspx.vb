    ...
    Protected Sub form1_Load(sender As Object, e As System.EventArgs) Handles form1.Load
        ...
        Using con As SqlConnection = New SqlConnection(DBCon)
            ...
            If dt.Rows.Count > 0 Then
                ...
                lbl_wallet_amount.Text = "- RM " + Convert.ToDecimal(dt.Rows(0)("Wallet_Amount")).ToString("N")
                lbl_product_wallet_amount.Text = "- RM " + Convert.ToDecimal(dt.Rows(0)("Product_Wallet_Amount")).ToString("N")
