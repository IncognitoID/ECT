<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Ipay88_Result_Activation.aspx.cs" Inherits="Ipay88_Result_Activation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        <div class="card mt-5 mb-5" id="div_success" runat="server">
            ...
            <p class="success_text">Successful activation your account.</p>
            <br />
            <br />
