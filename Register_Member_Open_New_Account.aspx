<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Register_Member_Open_New_Account.aspx.cs" Inherits="Register_Member_Open_New_Account" EnableEventValidation="false" %>
                                ...
                                <div class="form-group mb-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <label for="ctl00_ContentPlaceHolder1_btn_placement" class="toggle">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <select runat="server" id="ddl_package" class="form-control" onclick="updateTitle()">
                                                ...
                                                <option value="1" id="lbl_117" selected>1 Profit Center (1000BV)</option>
