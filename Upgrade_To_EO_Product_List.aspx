<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Upgrade_To_EO_Product_List.aspx.cs" Inherits="Upgrade_To_EO_Product_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Check_Selected_Value() {
            var radioButtonList = document.getElementById('ContentPlaceHolder1_rbtn_package');
            var selectedValue = '';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container p-3 mt-2 mb-5">
        ...
        <div class="row text-left mb-3">
            <div class="col-12 d-inline-flex">
                <p class="membership_title fw-200" id="lbl_331">Upgrade To EO - </p>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="row mb-3" runat="server" id="div_dc">
                        <div class="col-12">
                            <span id="lbl_334"></span>&nbsp;<asp:Label runat="server" CssClass="font-weight-bold" ID="lbl_user_dc" Style="font-size: 14px;"></asp:Label>
                        </div>
                    </div>
                    <div class="mb-3 mt-2">
                        <div class="row">
    ...
    <script type="text/javascript">
        ...
        function tr_style() {
            var table = document.getElementById("ContentPlaceHolder1_rbtn_package");
        ...
        function Load_Language() {
            var page = 'Upgrade EO Product Listing';
        ...
        function redirectToProduct(productCode) {
            ...
            var Agent_Level = getParameterByName('Agent_Level');
            var Package = getParameterByName('Package');
            window.location.href = "Upgrade_To_EO_Product_Details.aspx?id=" + productCode + "&member_id=" + member_id + "&Agent_Level=" + Agent_Level + "&Package=" + Package;
        }
        ...
        function increaseQuantity(btnPlus) {
            ...
            var currentQuantity = parseInt(quantityTextBox.value, 10);
            var max_qty = getCookieValue("Profit_Center");
            quantityTextBox.value = currentQuantity + 1;
        }
        ...
        function CheckFirstVariation() {
            ...
            $.ajax({
                type: "POST",
                url: "Upgrade_To_EO.aspx/ProcessArray",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
