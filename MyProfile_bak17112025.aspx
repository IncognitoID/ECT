...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        ...
        <div class="row m-auto div_padding_1">
            ...
            <div class="col-xl-3 col-12 mt-3" style="border-left: 5px solid orange; border-right: 5px solid orange; border-radius: 10px; margin: auto 0;">
        ...
        <div runat="server" id="div_eo_mission" class="row m-auto div_padding_3">
