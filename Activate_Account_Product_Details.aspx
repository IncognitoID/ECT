<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Activate_Account_Product_Details.aspx.cs" Inherits="Activate_Account_Product_Details" %>
    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function BackToPreviousPage() {
                window.location.href = "Activate_Account_Product_List.aspx";
            }
            ...
            function CheckFirstVariation() {
                ...
                $.ajax({
                    type: "POST",
                    url: "Activate_Account_Product_Details.aspx/ProcessArray",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
